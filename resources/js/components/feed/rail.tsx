...
/**
 * The four rules, each with the line that says what it actually means.
 *
 * They were four bare sentences. A rule a reader has to interpret is a rule
...
const COMMUNITY_RULE_NOTES: readonly string[] = [
    ...
    'A human reads every report and their actions are logged. Nothing disappears automatically.',
];
